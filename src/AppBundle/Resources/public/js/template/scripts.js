                        ...
                        $(window).on('load scroll', function() {
                            ...
                            if ((scrollTemp >= parallaxOffset1) && ($(window).scrollTop() <= parallaxOffset2)) {
                                ...
                                if (translateVal <= translateMax) {
                                    ...
                                    parallaxLayer_2.css({
                                        'transform': 'translate3d(0, -' + translateVal_2 + 'px, 0)'
                                    });
            ...
            jQuery(document).ready(function($) {
                $('.section_filter_block .filter_content_main').each(function(i) {
                    ...
                    $('#sort_btn').on('click', function() {
                        ...
                        if (queryTag1) {
                            queryTag = queryTag + queryTag1;
                        };
                        if (queryTag2) {
                            queryTag = queryTag + '+' + queryTag2;
                        };
                        if (queryTag[0] == '+') {
                            queryTag = queryTag.substr(1);
                        };
                        if (emptyTag) {
                            queryTag = queryTag + '/'
                        };
        ...
        try {
            ...
            jQuery(document).ready(function($) {
                ...
                $('#view_grid, #view_list').on('click', function() {
                    ...
                    $.cookie('productSortView', thisView, {
                        path: '/'
                    });
                ...
                if (theme.paginationTypeLoad) {
                    ...
                    $('#load_more_button').on('click', function() { //  when clicking on the button the load is replaced in the URL of the page number on the +1
                        ...
                        $.cookie(theme.collectionName, '?page=' + current_page, {
                            path: '/'
                        }); // set cookie with the modified page
                    ...
                    var checkStateOfPagination = function(page) {
                        if (page > 1 && pageFirstArrow.hasClass('hidden')) {
                            pageFirstArrow.removeClass('hidden');
                        }; // Here we hide the arrows at the extreme values of pagination
                        if (page == 1 && !(pageFirstArrow.hasClass('hidden'))) {
                            pageFirstArrow.addClass('hidden');
                        };
                        if (page > 2 && pagePrevArrow.hasClass('hidden')) {
                    ...
                    pageFirstArrow.on('click', function(e) {
                        ...
                        $.cookie(theme.collectionName, '?page=1', {
                            path: '/'
                        });
                    ...
                    pageLastArrow.on('click', function(e) {
                        ...
                        $.cookie(theme.collectionName, '?page=' + theme.paginatePages, {
                            path: '/'
                        });
                        document.location.href = newPageUrl;
                    });
                    ...
                    pagePrevArrow.on('click', function(e) {
                        ...
                        $.cookie(theme.collectionName, '?page=' + (current_page - 1), {
                            path: '/'
                        });
                        document.location.href = newPageUrl;
                    });
