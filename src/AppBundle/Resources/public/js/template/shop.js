                        ...
                        var selectCallback = function(variant, selector) {
                            if ( variant && variant.available ) {
                                ...
                                if( variant.price < variant.compare_at_price ){
                                    jQuery('#quick_view__price').html('<span class="money">' + Shopify.formatMoney(variant.price, "") + '</span><span class="money compare-at-price money_sale">' + Shopify.formatMoney(variant.compare_at_price, "") + '</span><span class="money_sale_percent">â€“ ' + parseInt( 100 - ( variant.price*100 )/variant.compare_at_price ) + '%</span>');
                                }
                                else {
